...
def generate_pic(dataset, config, image_id):
    ...
    print(r['rois'])
    print(r['scores'])
    visualize.display_differences(image, gt_bbox, gt_class_id, gt_mask, r['rois'], r['class_ids'],r['scores'],r['masks'], dataset.class_names,ax=ax)

    dirname = os.path.basename(CURRENT_DIR)
    plt.savefig("{}/result/differences/{}_prediction_{}.png".format(CURRENT_DIR,dirname,info["id"]))
