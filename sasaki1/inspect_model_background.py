...
import mrcnn.model_background as modellib
from mrcnn.model_background import log
import filament_fix
...
def main():
    ...
    log("gt_bbox", gt_bbox)
    log("gt_mask", gt_mask)
    plt.savefig("/home/maskrcnn/filament/result/predictions_background/{}/prediction_{}.png".format(args[1], info["id"]))
main()